    ...
    return (
        <div data-aos="fade-up" className="col-xl-6 col-md-6 col-sm-9 text-primary py-5 mx-auto">
            ...
            <p className="my-3">
                ...
                Bootstrap, JavaScript, jQuery, Reactjs. In addition i 
                have also basic knowledge in software version control using Git/Github
                and server side in web app, android app, desktop
                app development such as PHP, MYSQL, SQL Server, Firebase, REST Api
                C#, C++ and Java.
            </p>
