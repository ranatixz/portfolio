...
const RowB = ({workDetails}) =>{
    ...
    return (
        <div data-aos='fade-up' className="row my-5 py-2">
             <div className="col-xl-6 col-lg-6 order-xl-first order-lg-first order-last mx-auto my-1">
            ...
            <div className="col-xl-6 col-lg-6 order-first order-lg-first order-xl-last mx-auto my-1">
                <div className="mx-auto">
                    <img 
                        className="col-xl-12" 
